Este repositório contém um projeto base utilizando o React com o Vite como bundler. O Vite é um bundler de desenvolvimento rápido e otimizado para projetos baseados em JavaScript moderno, como o React.
